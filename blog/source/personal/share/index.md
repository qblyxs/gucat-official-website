...
// 页面说说
function pageTalk() {
    fetch('https://memos.gucat.vip/api/memo?creatorId=1&tag=分享&limit=30').then(res => res.json()).then(data => { // 注意修改域名和用户id
        let items = [],
            html = '',
