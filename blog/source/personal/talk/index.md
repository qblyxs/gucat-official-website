...
<div id="talk">
<div class='loading'><img src="/assets/loading3.gif" alt="加载中..."></div>
</div>
...
// 页面说说
function pageTalk() {
    fetch('https://memos.gucat.vip/api/memo?creatorId=1&tag=说说&limit=30').then(res => res.json()).then(data => { // 注意修改域名和用户id
        let items = [],
            html = '',
